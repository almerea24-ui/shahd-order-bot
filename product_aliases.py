...
BRAND_ALIASES = {
    'shahd': {
        # في شهد: بياض الثلج = بياض الثلج وجه كريم مباشرة
        'بياض الثلج وجه': 'بياض الثلج وجه كريم',
        'بياض الثلج': 'بياض الثلج وجه كريم',
        'بياض ثلج': 'بياض الثلج وجه كريم',
        'كريم بياض الثلج': 'بياض الثلج وجه كريم',
        'كورس بياض الثلج': 'بياض الثلج وجه كريم',
        'كريم بياض': 'بياض الثلج وجه كريم',
        'كورس بياض': 'بياض الثلج وجه كريم',
    },
    'marlin': {
...
PRODUCT_ALIASES = {
    ...
    # ===== بياض الثلج =====
    # شهد بيوتي: بياض الثلج وجه كريم (اسمه الحرفي في Odoo)
    # مارلين — كريم: كريم معالجة البشرة
    # مارلين — كورس: كورس معالجة البشرة
    # العبارات التي تحتوي على كورس/كريم = مارلين
    "كورس بياض": "كورس معالجة البشرة",
    "كورس بياض وجه": "كورس معالجة البشرة",
    "كورس بياض الثلج": "كورس معالجة البشرة",
    "كورس بياض الثلج وجه": "كورس معالجة البشرة",
    ...
    "كريم بياض الثلج": "كريم معالجة البشرة",
    "كريم بياض الثلج وجه": "كريم معالجة البشرة",
    # بياض الثلج بدون كورس/كريم — القاعدة:
    # شهد: بياض الثلج وجه كريم
    # مارلين: كورس معالجة البشرة (الافتراضي إذا لم يذكر كريم)
    # نضيف alias يحول لـ كورس معالجة البشرة — الفلتر يضمن أنه مارلين فقط
    # شهد عندها نفس الاسم في Odoo فالفلتر يجده مباشرة
    "بياض الثلج وجه": "كورس معالجة البشرة",
    "بياض الثلج": "كورس معالجة البشرة",
    "بياض ثلج": "كورس معالجة البشرة",
